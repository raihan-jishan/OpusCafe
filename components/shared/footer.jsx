    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex rounded-xl lg:items-start lg:gap-2 shadow-xl p-2">
          <div className="bg-orange-200 border-2 border-emerald-900 rounded-full p-2 max-lg:w-[18%]">
            <FiCoffee size={35} />
          </div>
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                <h2 className="text-4xl font-bold rounded p-2 text-gray-900 border-b-4 w-[10%]    fancy-border border-orange-200 max-lg:w-[50%]">
                  OpusCafé.
                </h2>
                ...
                <li>
                  <Button
                    className={buttonVariants({
                      className: "p-8 px-12  rounded-full",
                    })}
                  >
